...
public class CommentService {
    ...
    public boolean hasLikedComment(String ipAddress, Long commentId) {
        Optional<CommentLike> like = commentLikeRepository.findByIpAddressAndCommentId(ipAddress, commentId);
